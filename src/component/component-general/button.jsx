...
function Button({value , click ,styleButton , icon}) {
  const style = {
    ...
    style17:' w-[100%] h-[40px] bg-[#4d4d4d7f] shadow-custom-6 px-2 hover:scale-95  transition-all duration-300 text-zinc-100 rounded-md text-[1rem] flex justify-center items-center',
