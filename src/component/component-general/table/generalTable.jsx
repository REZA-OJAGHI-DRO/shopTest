...
function GeneralTable({items , headers , currentPage , setCurrentPage , rowsPerPage , setRowsPerPage , totalItems}) {
...
//   const totalItems = items.length;
  ...
  const filteredItems = items.filter(item =>
    item.requesterName.includes(filter) || item.acceptorName.includes(filter) || item.acceptorNationalId.includes(filter)
  );
  ...
  return (
    <div className="w-calc4 shadow-custom-6 rounded-3xl overflow-hidden">
