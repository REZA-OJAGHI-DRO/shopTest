...
const Form1 = ({
  ...
  const onSubmit = async (dataAll) => {
    ...
    hasChanged =
      ...
      dataT?.licenseCode == undefined ? false : dataT?.licenseCode !== dataAll.licenseCode ||
    ...
    if (hasChanged) {
      ...
      id: dataT?.id,
        ...
        isRetail: isRetail,
        licenseImage: imagesEdited2 == true ? dataImages2.length == 0 ?[] : dataImages2[0] : null,
        docOrRentImagesEdited: false,
        docOrRentImages:  null,
        categoryIdsEdited: imagesEdited3,
        categoryIds: imagesEdited3 == true ? categories : null,
        brandIdsEdited: imagesEdited4,
        brandIds: imagesEdited4 == true ? brand1 : null,
      };

      setLoad2(true);
      try {
        const result = await profileShopperUpdate(
          updatedData,
          token,
          chabk,
          setCheck,
