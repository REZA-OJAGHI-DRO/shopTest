  ...
  const onSubmit = async (dataAll) => {
    ...
    if (hasChanged) {
        const updatedData = {
          ...
          categoryIds: categoriesEdited == true ? categories : null,
          importBrandsEdited:isImporter == true ? brand2Edited : brand2.length == 0 && produceDescriptionImport == '' ? false : true,
          importBrands: isImporter == true ? brand2Edited == true ? brand2 : null : [],
          produceBrandsEdited:isProducer == true ? brand1Edited : brand1.length == 0 && produceDescriptionProduce == '' ? false : true,
          produceBrands: isProducer == true ? brand1Edited == true ? brand1 : null : [],
          spreaderBrandsEdited:isSpreader == true ? brand3Edited : brand3.length == 0 && produceDescriptionSpread == '' ? false : true,
          spreaderBrands:isSpreader == true ? brand3Edited == true ? brand3 : null : [],
          isPerson: null,
          // birthDate: "2024-12-09T19:50:58.219Z",
          birthDate: null,
          importDescription:isImporter == true ? dataT?.importDetails?.description !== produceDescriptionImport ? produceDescriptionImport : null : '',
          produceDescription:isProducer == true ? dataT?.produceDetails?.description !== produceDescriptionProduce ? produceDescriptionProduce : null : '',
          spreaderDescription:isSpreader == true ? dataT?.spreadDetails?.description !== produceDescriptionSpread ? produceDescriptionSpread : null : '',
