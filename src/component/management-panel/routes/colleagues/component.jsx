...
import FormCollegues from "./form-collegues/form-collegues.jsx";
import  '@/index.css'
import {
  React,
  useCallback,
              ...
              >
                ...
                >
                  <article className="w-[100%] flex justify-center">
                    <TableColleagues userId={userId} isNew={1} type={type} token={token} chabk={chabk} id={id} data={data.filter(item => item.isNew === false).filter(item => item.relationshipType === type)} currentPage={currentPage} setCurrentPage={setCurrentPage} rowsPerPage={rowsPerPage} setRowsPerPage={setRowsPerPage} totalItems={totalItems}/>
                  </article>
                  ...
                  {type==0?
                  <article className="w-[100%] flex justify-center">
                    <TableColleagues userId={userId} isNew={2} type={type} token={token} chabk={chabk} id={id} data={data.filter(item => item.isNew === true).filter(item => item.relationshipType === type)} currentPage={currentPage} setCurrentPage={setCurrentPage} rowsPerPage={rowsPerPage} setRowsPerPage={setRowsPerPage} totalItems={totalItems}/>
                  </article>
                  :''}
                </section>
              </div>
