    ...
    >
      ...
      >
        ...
        <ul
          className={`w-[100%] ${
            ...
            icon[0] == true
              ? "h-0"
              : "h-auto bg-[rgba(255,255,255,0.14)] rounded-lg"
          } overflow-hidden transition-all duration-300 py-1`}
        >
          <li
      ...
      >
        ...
        >
          <li
            ...
            }  bg-transparent hover:bg-[rgb(255,255,255,.2)] transition-all duration-300 py-1 cursor-pointer`}
          >
      ...
      >
        ...
        >
          ...
          >
            <Link to="UploadVideoSupplier" onClick={reload}>
              <span className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
