...
export async function postRelationshipGetList(
    ...
    const data = {
        "filter": {
            "currentMemberId": dataAll.currentMemberId,
            "currentMemberType": 0,
        },
...
export async function postRelationshipAnswer(date, dataAll, token, chabk , setMessageData) {
    ...
    const data = {
        ...
        "hasKnownFromYear":date ? date : null ,
